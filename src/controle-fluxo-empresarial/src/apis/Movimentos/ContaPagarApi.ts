...
class Api {
    ...
    CancelarBaixa(conta: CancelarContaPagar): Promise<AxiosResponse<any>> {
        return api.put(`${this.EndPoint}/cancelar-baixa/(${conta.modelo}:${conta.serie}:${conta.numero}:${conta.fornecedorId}:${conta.parcela})`, conta);
    }
