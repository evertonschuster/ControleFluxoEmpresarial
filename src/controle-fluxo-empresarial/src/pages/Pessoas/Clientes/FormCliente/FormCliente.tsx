...
import { Input, Select, DatePicker, InputMasked } from '../../../../components/WithFormItem/withFormItem';
    ...
    return (
        ...
        >
            ...
            <Row>
                ...
                <Col span={5}>
                    <Input name="limiteCredito" label="Limite de Crédito" placeholder="500,00" required />
                </Col>
