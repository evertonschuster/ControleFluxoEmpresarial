...
CREATE TABLE Equipamentos (
    ...
    CONSTRAINT FK_Equipamentos_AspNetUsers_UserCriacao FOREIGN KEY (UserCriacao) REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT FK_Equipamentos_AspNetUsers_UserAtualizacao FOREIGN KEY (UserAtualizacao) REFERENCES "AspNetUsers" ("Id")
);

CREATE TABLE ProblemasRelatado (
    Id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    Nome VARCHAR(50) NOT NULL,
	Situacao TIMESTAMP WITH TIME ZONE,
    ...
    CONSTRAINT PK_ProblemasRelatado PRIMARY KEY (Id),
    CONSTRAINT FK_ProblemasRelatado_AspNetUsers_UserCriacao FOREIGN KEY (UserCriacao) REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT FK_ProblemasRelatado_AspNetUsers_UserAtualizacao FOREIGN KEY (UserAtualizacao) REFERENCES "AspNetUsers" ("Id")
);
...
CREATE TABLE OrdensServico (
    ...
    ProblemaRelatadoId INTEGER NOT NULL,
	...
	FOREIGN KEY (ProblemaRelatadoId) REFERENCES ProblemasRelatado (Id) ,
	FOREIGN KEY (CondicaoPagamentoId) REFERENCES CondicaoPagamentos (Id) ,
